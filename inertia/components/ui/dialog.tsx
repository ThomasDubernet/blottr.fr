...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] border bg-background duration-200',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute opacity-70 ring-offset-background transition-opacity',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-semibold leading-none tracking-tight dialog-title-responsive', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-muted-foreground dialog-description-responsive', className)}
    {...props}
  />
))
