  ...
  async run() {
    ...
    const cities = [
      ...
      },
      {
        ...
        seoKeywords: ['tatoueur marseille', 'tattoo marseille', 'studio tatouage marseille'],
        isActive: true,
        isFeatured: true,
        priority: 2,
      },
      ...
      },
      {
        ...
        seoKeywords: ['tatoueur toulouse', 'tattoo toulouse', 'studio tatouage toulouse'],
        isActive: true,
        isFeatured: true,
        priority: 4,
      },
      ...
      },
      {
        ...
        seoKeywords: ['tatoueur montpellier', 'tattoo montpellier', 'studio tatouage montpellier'],
        isActive: true,
        isFeatured: true,
        priority: 7,
      },
      {
        ...
        seoKeywords: ['tatoueur strasbourg', 'tattoo strasbourg', 'salon tatouage strasbourg'],
        isActive: true,
        isFeatured: false,
        priority: 10,
      },
      {
        ...
        seoKeywords: ['tatoueur bordeaux', 'tattoo bordeaux', 'studio tatouage bordeaux'],
        isActive: true,
        isFeatured: true,
        priority: 8,
      },
      ...
      // Additional cities for better coverage
      {
        ...
        seoKeywords: ['tatoueur le havre', 'tattoo le havre', 'studio tatouage havre'],
        isActive: true,
        isFeatured: false,
        priority: 20,
      },
      {
        ...
        seoKeywords: ['tatoueur saint etienne', 'tattoo saint etienne', 'salon tatouage loire'],
        isActive: true,
        isFeatured: false,
        priority: 25,
      },
