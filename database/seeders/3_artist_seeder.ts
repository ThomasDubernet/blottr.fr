    ...
    const artistsData = [
      {
        ...
        artStyles: JSON.stringify(['réalisme', 'traditionnel', 'japonais', 'portrait', 'noir-et-blanc']),
        cityId: paris.id,
        ...
        seoKeywords: JSON.stringify(['alex ink', 'tatoueur paris', 'réalisme', 'traditionnel', 'portrait tattoo']),
      },
      {
        ...
        artStyles: JSON.stringify(['fine-line', 'floral', 'minimaliste', 'aquarelle', 'féminin']),
        cityId: paris.id,
        ...
        minPrice: 100,
        maxPrice: 280,
        portfolioImages: JSON.stringify(['https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=800']),
      ...
      },
      {
        ...
        experienceLevel: ArtistExperienceLevel.EXPERT,
        artStyles: JSON.stringify(['traditionnel-japonais', 'géométrique', 'biomécanique', 'new-school']),
        cityId: lyon.id,
      ...
      },
      {
        ...
        experienceLevel: ArtistExperienceLevel.ADVANCED,
        artStyles: JSON.stringify(['portrait', 'néo-traditionnel', 'réalisme-coloré', 'art-figuratif']),
        cityId: lyon.id,
        primarySalonId: lyonCollective?.id,
        acceptsBookings: true,
        appointmentOnly: true,
      ...
      },
      {
        ...
        experienceLevel: ArtistExperienceLevel.ADVANCED,
        artStyles: JSON.stringify(['maritime', 'tribal', 'provençal', 'nautique', 'méditerranéen']),
        cityId: marseille.id,
      ...
      },
      {
        ...
        experienceLevel: ArtistExperienceLevel.ADVANCED,
        artStyles: JSON.stringify(['aquarelle', 'néo-traditionnel', 'sur-mesure', 'cover-up']),
        cityId: bordeaux.id,
      ...
      },
      {
        ...
        artStyles: JSON.stringify(['new-school', 'pop-art', 'cartoon', 'illustration', 'coloré']),
        cityId: toulouse.id,
