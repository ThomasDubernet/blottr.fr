...
if [ -f "KNOWLEDGE_BASE.md" ]; then
    ...
    sed '/## Project Status (Auto-Updated)/,/\*Auto-generated by scripts\/update-knowledge-base\.sh\*/d' KNOWLEDGE_BASE.md > /tmp/kb_clean.md

    # Append new section
    cat /tmp/kb_clean.md /tmp/kb_update.md > KNOWLEDGE_BASE.md

    echo "✅ Knowledge Base updated successfully!"
else
    echo "❌ KNOWLEDGE_BASE.md not found!"
    exit 1
fi
